...
func (m *SearchQueryMutation) SetLocCode(i int) {
	m.loc_code = &i
	m.addloc_code = nil
}

// LocCode returns the value of the "loc_code" field in the mutation.
func (m *SearchQueryMutation) LocCode() (r int, exists bool) {
	v := m.loc_code
	if v == nil {
		return
	}
...
// OldLocCode returns the old "loc_code" field's value of the SearchQuery entity.
// If the SearchQuery object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SearchQueryMutation) OldLocCode(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldLocCode is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldLocCode requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldLocCode: %w", err)
	}
	return oldValue.LocCode, nil
}

// AddLocCode adds i to the "loc_code" field.
func (m *SearchQueryMutation) AddLocCode(i int) {
	if m.addloc_code != nil {
		*m.addloc_code += i
	} else {
		m.addloc_code = &i
	}
...
// AddedLocCode returns the value that was added to the "loc_code" field in this mutation.
func (m *SearchQueryMutation) AddedLocCode() (r int, exists bool) {
	v := m.addloc_code
	if v == nil {
		return
	}
...
// ResetLocCode resets all changes to the "loc_code" field.
func (m *SearchQueryMutation) ResetLocCode() {
	m.loc_code = nil
	m.addloc_code = nil
}
...
func (m *SearchQueryMutation) SetJobID(u uuid.UUID) {
	m.job_id = &u
}

// JobID returns the value of the "job_id" field in the mutation.
func (m *SearchQueryMutation) JobID() (r uuid.UUID, exists bool) {
	v := m.job_id
	if v == nil {
		return
	}
...
// OldJobID returns the old "job_id" field's value of the SearchQuery entity.
// If the SearchQuery object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SearchQueryMutation) OldJobID(ctx context.Context) (v uuid.UUID, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *SearchQueryMutation) ClearJobID() {
	m.job_id = nil
	m.clearedFields[searchquery.FieldJobID] = struct{}{}
}

// JobIDCleared returns if the "job_id" field was cleared in this mutation.
func (m *SearchQueryMutation) JobIDCleared() bool {
	_, ok := m.clearedFields[searchquery.FieldJobID]
	return ok
}

// ResetJobID resets all changes to the "job_id" field.
func (m *SearchQueryMutation) ResetJobID() {
	m.job_id = nil
	delete(m.clearedFields, searchquery.FieldJobID)
}

// SetIsFinished sets the "is_finished" field.
func (m *SearchQueryMutation) SetIsFinished(b bool) {
	m.is_finished = &b
}

// IsFinished returns the value of the "is_finished" field in the mutation.
func (m *SearchQueryMutation) IsFinished() (r bool, exists bool) {
	v := m.is_finished
	if v == nil {
		return
	}
...
// OldIsFinished returns the old "is_finished" field's value of the SearchQuery entity.
// If the SearchQuery object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SearchQueryMutation) OldIsFinished(ctx context.Context) (v bool, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *SearchQueryMutation) ResetIsFinished() {
	m.is_finished = nil
}
...
func (m *SearchQueryMutation) Fields() []string {
	...
	if m.loc_code != nil {
		fields = append(fields, searchquery.FieldLocCode)
	}
	if m.language != nil {
		fields = append(fields, searchquery.FieldLanguage)
	}
	if m.job_id != nil {
		fields = append(fields, searchquery.FieldJobID)
	}
	if m.is_finished != nil {
		fields = append(fields, searchquery.FieldIsFinished)
	}
	if m.created_at != nil {
...
func (m *SearchQueryMutation) ClearedFields() []string {
	var fields []string
	if m.FieldCleared(searchquery.FieldJobID) {
		fields = append(fields, searchquery.FieldJobID)
	}
	return fields
}
