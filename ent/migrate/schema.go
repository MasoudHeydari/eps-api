...
var (
	...
	SearchQueriesColumns = []*schema.Column{
		...
		{Name: "loc_code", Type: field.TypeInt},
	...
	SearchQueriesTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			{
				Name:    "searchquery_query_loc_code_language_job_id_is_finished",
				Unique:  true,
				Columns: []*schema.Column{SearchQueriesColumns[1], SearchQueriesColumns[2], SearchQueriesColumns[3], SearchQueriesColumns[4], SearchQueriesColumns[5]},
			},
		},
	}
