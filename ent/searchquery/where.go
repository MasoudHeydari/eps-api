...
// LocCode applies equality check predicate on the "loc_code" field. It's identical to LocCodeEQ.
func LocCode(v int) predicate.SearchQuery {
	return predicate.SearchQuery(sql.FieldEQ(FieldLocCode, v))
}
...
func JobID(v uuid.UUID) predicate.SearchQuery {
	return predicate.SearchQuery(sql.FieldEQ(FieldJobID, v))
}

// IsFinished applies equality check predicate on the "is_finished" field. It's identical to IsFinishedEQ.
func IsFinished(v bool) predicate.SearchQuery {
	return predicate.SearchQuery(sql.FieldEQ(FieldIsFinished, v))
}
...
func LocCodeEQ(v int) predicate.SearchQuery {
	return predicate.SearchQuery(sql.FieldEQ(FieldLocCode, v))
}

// LocCodeNEQ applies the NEQ predicate on the "loc_code" field.
func LocCodeNEQ(v int) predicate.SearchQuery {
	return predicate.SearchQuery(sql.FieldNEQ(FieldLocCode, v))
}

// LocCodeIn applies the In predicate on the "loc_code" field.
func LocCodeIn(vs ...int) predicate.SearchQuery {
	return predicate.SearchQuery(sql.FieldIn(FieldLocCode, vs...))
}

// LocCodeNotIn applies the NotIn predicate on the "loc_code" field.
func LocCodeNotIn(vs ...int) predicate.SearchQuery {
	return predicate.SearchQuery(sql.FieldNotIn(FieldLocCode, vs...))
}

// LocCodeGT applies the GT predicate on the "loc_code" field.
func LocCodeGT(v int) predicate.SearchQuery {
	return predicate.SearchQuery(sql.FieldGT(FieldLocCode, v))
}

// LocCodeGTE applies the GTE predicate on the "loc_code" field.
func LocCodeGTE(v int) predicate.SearchQuery {
	return predicate.SearchQuery(sql.FieldGTE(FieldLocCode, v))
}

// LocCodeLT applies the LT predicate on the "loc_code" field.
func LocCodeLT(v int) predicate.SearchQuery {
	return predicate.SearchQuery(sql.FieldLT(FieldLocCode, v))
}

// LocCodeLTE applies the LTE predicate on the "loc_code" field.
func LocCodeLTE(v int) predicate.SearchQuery {
	return predicate.SearchQuery(sql.FieldLTE(FieldLocCode, v))
}
...
func JobIDEQ(v uuid.UUID) predicate.SearchQuery {
	return predicate.SearchQuery(sql.FieldEQ(FieldJobID, v))
}

// JobIDNEQ applies the NEQ predicate on the "job_id" field.
func JobIDNEQ(v uuid.UUID) predicate.SearchQuery {
	return predicate.SearchQuery(sql.FieldNEQ(FieldJobID, v))
}

// JobIDIn applies the In predicate on the "job_id" field.
func JobIDIn(vs ...uuid.UUID) predicate.SearchQuery {
	return predicate.SearchQuery(sql.FieldIn(FieldJobID, vs...))
}

// JobIDNotIn applies the NotIn predicate on the "job_id" field.
func JobIDNotIn(vs ...uuid.UUID) predicate.SearchQuery {
	return predicate.SearchQuery(sql.FieldNotIn(FieldJobID, vs...))
}

// JobIDGT applies the GT predicate on the "job_id" field.
func JobIDGT(v uuid.UUID) predicate.SearchQuery {
	return predicate.SearchQuery(sql.FieldGT(FieldJobID, v))
}

// JobIDGTE applies the GTE predicate on the "job_id" field.
func JobIDGTE(v uuid.UUID) predicate.SearchQuery {
	return predicate.SearchQuery(sql.FieldGTE(FieldJobID, v))
}

// JobIDLT applies the LT predicate on the "job_id" field.
func JobIDLT(v uuid.UUID) predicate.SearchQuery {
	return predicate.SearchQuery(sql.FieldLT(FieldJobID, v))
}

// JobIDLTE applies the LTE predicate on the "job_id" field.
func JobIDLTE(v uuid.UUID) predicate.SearchQuery {
	return predicate.SearchQuery(sql.FieldLTE(FieldJobID, v))
}

// JobIDIsNil applies the IsNil predicate on the "job_id" field.
func JobIDIsNil() predicate.SearchQuery {
	return predicate.SearchQuery(sql.FieldIsNull(FieldJobID))
}

// JobIDNotNil applies the NotNil predicate on the "job_id" field.
func JobIDNotNil() predicate.SearchQuery {
	return predicate.SearchQuery(sql.FieldNotNull(FieldJobID))
}

// IsFinishedEQ applies the EQ predicate on the "is_finished" field.
func IsFinishedEQ(v bool) predicate.SearchQuery {
	return predicate.SearchQuery(sql.FieldEQ(FieldIsFinished, v))
}

// IsFinishedNEQ applies the NEQ predicate on the "is_finished" field.
func IsFinishedNEQ(v bool) predicate.SearchQuery {
	return predicate.SearchQuery(sql.FieldNEQ(FieldIsFinished, v))
}
