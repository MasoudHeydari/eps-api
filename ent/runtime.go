...
import (
	...
	"github.com/MasoudHeydari/eps-api/ent/schema"
...
func init() {
	...
	// searchqueryDescIsFinished is the schema descriptor for is_finished field.
	searchqueryDescIsFinished := searchqueryFields[4].Descriptor()
	// searchquery.DefaultIsFinished holds the default value on creation for the is_finished field.
	searchquery.DefaultIsFinished = searchqueryDescIsFinished.Default.(bool)
	// searchqueryDescCreatedAt is the schema descriptor for created_at field.
	searchqueryDescCreatedAt := searchqueryFields[5].Descriptor()
