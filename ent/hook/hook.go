...
// The SERPFunc type is an adapter to allow the use of ordinary
// function as SERP mutator.
type SERPFunc func(context.Context, *ent.SERPMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f SERPFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.SERPMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.SERPMutation", m)
}
